...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateTextViews(SensorEvent sensorEvent)
    {
        ...
        ((TextView) findViewById(R.id.z_text)).setText("Z Gravity : " +Float.toString(sensorEvent.values[2]));
        ((TextView) findViewById(R.id.vx_text)).setText("Vx : " +Float.toString(ball.getVx0()));
        ((TextView) findViewById(R.id.vy_text)).setText("Vy : " +Float.toString(ball.getVy0()));
    }
}
